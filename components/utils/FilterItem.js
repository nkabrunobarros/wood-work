  ...
  if (Object.keys(data).length !== 0 || true) {
    ...
    case 1: {
      ...
      case 'Estado': {
        ...
        case 'needs analysis': return <Typography variant='md' className="analisysBalloon">Pendente Análise Necessidades</Typography>;
        case 'waiting budget': return <Typography variant='md' className="waitingBudgetBalloon">Pendente Orçamentação</Typography>;
        case 'waiting adjudication': return <Typography variant='md' className="infoBalloon">Pendente Adjudicação</Typography>;
        case 'drawing': return <Typography variant='md' className="drawingBalloon">Pendente Desenho</Typography>;
        case 'production': return <Typography variant='md' className="productionBalloon">Pendente Produção</Typography>;
        case 'packing': return <Typography variant='md' className="packingBalloon">Pendente Embalamento</Typography>;
        case 'testing': return <Typography variant='md' className="assemblyBalloon">Pendente Montagem</Typography>;
        case 'transport': return <Typography variant='md' className="expeditionBalloon">Pendente Expedição</Typography>;
